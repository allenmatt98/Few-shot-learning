# -*- coding: utf-8 -*-
"""
Created on Tue Mar 30 17:10:39 2021
...
Input: 
 ...
 - weights: A list of weights. If this is set to None, then all detectors
            will be considered equally reliable. The sum of weights should be 1.
Output:
    A list of boxes, on the same format as the input. Confidences are in range 0-1.
"""
def Ensemble(dets, iou_thresh = 0.5, weights=None):
...
if __name__=="__main__":
    ...
    ens = Ensemble(dets, weights = [0.5,0.5])
    print(ens)